  ...
  return (
    <div className="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
      <div className="flex items-baseline justify-between">
        ...
        <span className="text-sm text-zinc-500">{new Date(price.timestamp).toLocaleString()}</span>
      </div>
      ...
      <div className="mt-4 grid grid-cols-2 gap-3 text-sm sm:grid-cols-4">
        <div>
          <div className="text-zinc-500">P/E</div>
          <div className="font-medium text-zinc-900 dark:text-zinc-50">{formatNumber(fundamentals.pe_ratio)}</div>
        </div>
        <div>
          <div className="text-zinc-500">Market Cap</div>
          <div className="font-medium text-zinc-900 dark:text-zinc-50">{formatMarketCap(fundamentals.market_cap)}</div>
        </div>
        <div>
          <div className="text-zinc-500">EPS</div>
          <div className="font-medium text-zinc-900 dark:text-zinc-50">{formatNumber(fundamentals.eps)}</div>
        </div>
        <div>
          <div className="text-zinc-500">52wk Range</div>
