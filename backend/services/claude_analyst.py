...
BRIEF_SYSTEM_PROMPT = (
    ...
    "about a stock: price action, fundamentals, and recent news headlines with "
    "sentiment scores. Write a single tight paragraph (max 120 words) summarizing "
    "what's happening with this stock right now and why. Ground every claim in "
...
def generate_brief(symbol: str, price: dict, fundamentals: dict, news: list[dict]) -> str:
    payload = {
        "symbol": symbol,
        "price": price,
